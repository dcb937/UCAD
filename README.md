...
## Introduction
This repo is the official implementation of _UCAD: Uncertainty-Guided Contour-Aware Displacement for Semi-Supervised Medical Image Segmentation_ which is accepted to ISBI-2026.
